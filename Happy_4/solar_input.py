...
def solar(lat, lon):
    ...
    # collect the data from 2000 to 2015
    ...
    # average the daily solar energy data from 2000 to 2015                                  
    ...
    date_list = pd.date_range('1/1/2018', freq='1D', periods=365)
   
    # free the memory
    ssc.data_free(dat)
    ssc.module_free(mod)
    
    # sum everyday energy generation to get the solar energy geneartion of a year                                       
    generation_solar = daily_solar_average['generation'].sum()/system_capacity
    
    return daily_solar_average,generation_solar