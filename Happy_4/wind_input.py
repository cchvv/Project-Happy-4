...
wind(lat, lon):
    ...
    # collect the data from 2007 to 2012
    ...
    # average the daily wind energy data from 2007 to 2012     
    ...
    generation_wind = daily_wind_average['generation'].sum()
    ...
    return daily_wind_average, generation_wind